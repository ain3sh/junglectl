...
async function selectFromCached(cached, config) {
...
async function selectManually(config) {
...
async function discoverAndSelect(config) {
...
async function selectFromDiscovered(discovered) {
    try {
        const selected = await search({
            message: 'Which CLI would you like to explore?',
            source: async (input) => {
...
async function finalizeCLISelection(newCLI, config) {
